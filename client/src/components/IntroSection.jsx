...
const IntroSection = () => {
  return (
    <div className="flex flex-col items-center justify-center pb-16">
      ...
      <p className="text-gray-500 text-center mb-8">Bring your imagination to life with AI-generated visuals</p>
      <div className="flex flex-col gap-5 md:flex-row">
        ...
        <div className="flex flex-col pt-12 gap-6 md:w-[50%]">
          <h1 className="text-gray-800 text-2xl">Experience the Power of AI Image Creation</h1>
