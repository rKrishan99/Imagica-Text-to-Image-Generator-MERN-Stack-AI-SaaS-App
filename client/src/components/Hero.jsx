  ...
  return (
    <div className="flex flex-col mt-24 items-center">
      ...
      <h1 className="md:text-6xl text-center md:max-w-[700px] sm:text-7xl sm:max-w-[590px] mx-auto mt-10">
        ...
        <span className="text-violet-400">Images</span> Instantly.
      </h1>

      <p className="text-center max-w-[300px] sm:max-w-[590px] mt-12 text-gray-400">
      ...
      <div class="relative group cursor-pointer mt-20 mb-12 rounded-full">
        ...
        <div class="relative bg-white ring-1 ring-gray-900/5 rounded-full ">
          <button class="flex justify-center px-8 bg-gradient-to-bl from-red-800 to-violet-800 group-hover:from-gray-950 group-hover:to-violet-800 rounded-full py-[10px] items-center gap-3 sm:text-lg w-auto font-light text-black cursor-pointer">
